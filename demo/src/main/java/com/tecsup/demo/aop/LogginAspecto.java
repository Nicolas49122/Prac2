...
public class LogginAspecto {
    ...
    public void auditoria(JoinPoint joinPoint) {
        ...
        try {
            if (metodo.startsWith("guardar") && entidad instanceof Coche) {
                Coche coche = (Coche) entidad;
                id = coche.getId(); // Asigna directamente el id como Integer
            } else if (metodo.startsWith("guardar") && entidad instanceof Inspeccion) {
                Inspeccion inspeccion = (Inspeccion) entidad;
                id = inspeccion.getId(); // Asigna directamente el id como Integer
